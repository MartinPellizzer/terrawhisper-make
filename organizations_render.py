...
def render_listing(row):
    name = row['business_name_official']
    slug = to_slug(name)
    ...
    ## Business Overview
    fields = {
        'official business name': row['business_name_official'],
        'business slogan': row['business_slogan'],
        'short business description': row['business_description_short'],
        'business description': row['business_description'],
        'primary business type': row['business_type_primary'],
        'secondary business type': row['business_type_secondary'],
        'business industry': row['business_industry'],
        'business niche': row['business_niche'],
        'business model': row['business_model'],
        'business status': row['business_status'],
    }
