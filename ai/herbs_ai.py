...
def herb_ailments_llm_list_1_try_hint_gen(herb_filepath, regen=False, clear=False):
    ...
    if entity_herb[key] == '' or entity_herb[key] == []:
        ...
        for i in range(1):
            ...
            import textwrap
            prompt = textwrap.dedent(f''' 
                Tell me the primary common ailments the following plant treats: {herb_name_scientific}.
                In specific, write a confidence score from 1 to 10, indicating how sure you are about your answer.
                Reply using the following JSON format:
                [
                    {{"answer": "write disease name 1 here", "score": "write score 1 here"}}
...
def herb_preparations_llm_list_1_try_hint_gen(herb_filepath, regen=False, clear=False):
    entity_herb = io.json_read(herb_filepath)
    herb_name_scientific = entity_herb['herb_name_scientific']
    ...
    if entity_herb[key] == '' or entity_herb[key] == []:
        ...
        for i in range(1):
            ...
            import textwrap
            prompt = textwrap.dedent(f''' 
                Tell me the main herbal preparations of the following plant: {herb_name_scientific}.
                By herbal preparations I mean things like infusions, tinctures, essential oils, etc.
                In specific, write a confidence score from 1 to 10, indicating how sure you are about your answer.
                Reply using the following JSON format:
                [
                    {{"answer": "write preparation name 1 here", "score": "write score 1 here"}}
                ]
                Reply only with the JSON.
                Reply using as few words as possible.
                If you don't know the answer, reply only with the word "NONE".
            ''').strip()
            prompt += f'\n/no_think'
            print(prompt)
            reply = llm.reply(prompt)
            ...
            if json_data != {}:
                ...
                for item in json_data:
                    ...
                    if answer.lower().strip() == 'none': continue
                    _objs.append({
                        "answer": answer, 
                        "score": score,
                    })
...
def herb_side_effects_llm_list_1_try_hint_gen(herb_filepath, regen=False, clear=False):
    entity_herb = io.json_read(herb_filepath)
    herb_name_scientific = entity_herb['herb_name_scientific']
    ...
    if entity_herb[key] == '' or entity_herb[key] == []:
        ...
        for i in range(1):
            ...
            import textwrap
            prompt = textwrap.dedent(f''' 
                Tell me the all possible health side effects the following plant: {herb_name_scientific}.
                By side effects I mean things nausea, dizziness, etc.
                In specific, write a confidence score from 1 to 10, indicating how sure you are about your answer.
                Reply using the following JSON format:
                [
                    {{"answer": "write side effect name 1 here", "score": "write score 1 here"}}
                ]
                Reply only with the JSON.
                Reply using as few words as possible.
                If you don't know the answer, reply only with the word "NONE".
...
def herb_actions_gen(herb_filepath, regen=False, clear=False):
    entity_herb = io.json_read(herb_filepath)
    herb_name_scientific = entity_herb['herb_name_scientific']
    key = 'herb_actions'
    if key not in entity_herb: entity_herb[key] = ''
    ...
    if entity_herb[key] == '' or entity_herb[key] == []:
        ...
        for i in range(10):
            ...
            main_list_prompt = '\n'.join(main_list_prompt)
            prompt = textwrap.dedent(f''' 
                Tell me the pharmacological actions of the following plant with scientific name: {herb_name_scientific}.
                In specific, write a confidence score from 1 to 10, indicating how sure you are about your answer.
                The possible pharmacological actions are the following:
                {main_list_prompt}
                Reply using the following JSON format:
                [
                    {{"answer": "write pharmacological action name 1 here", "score": "write score 1 here"}},
                    {{"answer": "write pharmacological action name 2 here", "score": "write score 2 here"}},
                    {{"answer": "write pharmacological action name 3 here", "score": "write score 3 here"}},
                    {{"answer": "write pharmacological action name 4 here", "score": "write score 4 here"}},
                    {{"answer": "write pharmacological action name 5 here", "score": "write score 5 here"}},
                    {{"answer": "write pharmacological action name 6 here", "score": "write score 6 here"}},
                    {{"answer": "write pharmacological action name 7 here", "score": "write score 7 here"}},
                    {{"answer": "write pharmacological action name 8 here", "score": "write score 8 here"}},
                    {{"answer": "write pharmacological action name 9 here", "score": "write score 9 here"}},
                    {{"answer": "write pharmacological action name 10 here", "score": "write score 10 here"}}
                ]
                Reply only with the JSON.
            ''').strip()
            prompt += f'\n/no_think'
...
def herb_symptoms_gen(herb_filepath, regen=False, clear=False):
    entity_herb = io.json_read(herb_filepath)
    herb_name_scientific = entity_herb['herb_name_scientific']
    key = 'herb_symptoms'
    if key not in entity_herb: entity_herb[key] = ''
    ...
    if clear: 
        ...
        return
    if entity_herb[key] == '' or entity_herb[key] == []:
        items = [item.lower().strip() for item in data.symptoms_get(10)]
        main_list_text = '\n'.join([
            item.lower().strip()
            for item in items
        ])
        ...
        for i in range(10):
            ...
            main_list_prompt = '\n'.join(main_list_prompt)
            prompt = textwrap.dedent(f''' 
                Tell me the what symptoms are treated with the following plant with scientific name: {herb_name_scientific}.
                In specific, write a confidence score from 1 to 10, indicating how sure you are about your answer.
                The possible symptoms are the following:
                {main_list_prompt}
                Reply using the following JSON format:
                [
                    {{"answer": "write symptom name 1 here", "score": "write score 1 here"}},
                    {{"answer": "write symptom name 2 here", "score": "write score 2 here"}},
                    {{"answer": "write symptom name 3 here", "score": "write score 3 here"}},
                    {{"answer": "write symptom name 4 here", "score": "write score 4 here"}},
                    {{"answer": "write symptom name 5 here", "score": "write score 5 here"}},
                    {{"answer": "write symptom name 6 here", "score": "write score 6 here"}},
                    {{"answer": "write symptom name 7 here", "score": "write score 7 here"}},
                    {{"answer": "write symptom name 8 here", "score": "write score 8 here"}},
                    {{"answer": "write symptom name 9 here", "score": "write score 9 here"}},
                    {{"answer": "write symptom name 10 here", "score": "write score 10 here"}}
                ]
                Reply only with the JSON.
            ''').strip()
            prompt += f'\n/no_think'
...
def herbs_medicinal_validated_gen():
    ...
    for herb_i, herb in enumerate(herbs):
        ...
        print(f'{herb_i}/{len(herbs)} - {herb}')
        print('####################################')
        herbs_medicinal_validated_json(herb)
        print()
        print()
        print()
...
def herbs_wiki_powo_species():
    ...
    for row_i, row in enumerate(rows):
        ...
        herb_preparations_llm_list_1_try_hint_gen(output_filepath, regen=False, clear=False)
        herb_side_effects_llm_list_1_try_hint_gen(output_filepath, regen=False, clear=False)
        continue
        ###
        herb_preparations_monograph_gen(herb_filepath, regen=False, clear=False)
        herb_actions_gen(herb_filepath, regen=False, clear=False)
