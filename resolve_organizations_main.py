...
def resolve_businesses(source_foldername):
    input_folderpath = f'{HUB_FOLDERPATH}/normalize/{source_foldername}/details/json'
    output_folderpath = f'{HUB_FOLDERPATH}/resolve/{source_foldername}/details/json'
...
def resolve_reviews(source_foldername):
    input_folderpath = f'{HUB_FOLDERPATH}/normalize/{source_foldername}/reviews/json'
    output_folderpath = f'{HUB_FOLDERPATH}/resolve/{source_foldername}/reviews/json'
    try: shutil.rmtree(output_folderpath)
    except: pass
    io.folders_recursive_gen(output_folderpath)
    input_filenames = sorted(os.listdir(input_folderpath))
