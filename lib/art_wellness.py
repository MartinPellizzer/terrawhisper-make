...
def art_wellness_skin_care_herbs_json_gen(article_data):
    ...
    json_article['article_title'] = f'''{main_lst_num} skin care herbs for Glowing and Healthy Skin'''
    ...
    json_article['main_lst_num'] = main_lst_num
    io.json_write(json_article_filepath, json_article)
    art_wellness_skin_care_herbs_json_gen_intro(article_data, regen=False, dispel=False)
    art_wellness_skin_care_herbs_json_gen_list_init(article_data, regen=False, dispel=False)
    art_wellness_skin_care_herbs_json_gen_list_desc(article_data, regen=False, dispel=False)

def art_wellness_skin_care_herbs_images_gen(article_data, regen=False):
...
def art_wellness_skin_care_herbs():
    ...
    art_wellness_skin_care_herbs_images_gen(article_data, regen=False)
