...
def herbs__herb_morphology__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Plant Description and Morphology'
    brief = f'''
        Include the following subtopics:
    ...
    if not dispel:
        if json_article[key] == '':
            ...
            prompt = textwrap.dedent(f'''
                ...
                BRIEF:
                {brief}
                Start with the following words: {herb_name_common} is  
                /no_think
            ''').strip()
            reply = llm.reply(prompt)
            if '</think>' in reply:
...
def herbs__herb_distribution__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Native Habitat and Distribution'
    brief = f'''
        Include the following subtopics:
        - Native regions
...
def herbs__herb_pharmacological__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Pharmacological Properties'
    brief = f'''
        Include the following subtopics:
        - Therapeutic actions
        - Biological activity
...
def herbs__herb_mechanisms__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Mechanisms of Action'
    brief = f'''
        Include the following subtopics:
        - Cellular mechanisms
...
def herbs__herb_uses__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Therapeutic Uses'
    brief = f'''
        Include the following subtopics:
        - therapeutic uses of this medicinal plant
        - conditions / common ailments it treats
    '''
    key = 'uses'
    ### llm
    json_article = io.json_read(json_article_filepath, create=True)
...
def herbs__herb_dosage__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    brief = f'''
        ...
        - Frequency
        - Duration
        Be very conservative with the dosage, I want to avoid people overusing it and get sick.
    '''
    key = 'dosage'
    ### llm
    json_article = io.json_read(json_article_filepath, create=True)
...
def herbs__herb_safety__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Safety, Side Effects, and Contraindications'
    brief = f'''
        Include the following subtopics:
        - Side effects
        - Contraindications
...
def herbs__herb_drug__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
...
def herbs__herb_toxicity__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Toxicity and Precautions'
    brief = f'''
        Include the following subtopics:
        - Toxic dose
        - Long-term safety
...
def herbs__herb_cultivation__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Cultivation and Harvesting'
    brief = f'''
        Include the following subtopics:
        - Soil requirements
        - Sunlight
...
def herbs__herb_processing__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Processing and Extraction'
    brief = f'''
        Include the following subtopics when applicable:
        - Drying
        - Extraction
...
def herbs__herb_storage__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Storage and Shelf Life'
    brief = f'''
        Include the following subtopics when applicable:
        - Shelf life
        - Storage conditions
...
def herbs__herb_scientific__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
...
def herbs__herb_traditional__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Traditional and Historical Uses'
    brief = f'''
        Include the following subtopics when applicable:
...
def herbs__herb_regulatory__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
...
def herbs__herb_sustainability__gen(herb, json_article_filepath, regen=False, dispel=False):
    herb_name_scientific = herb['taxon_name']
    herb_slug = polish.sluggify(herb_name_scientific)
    ### data glo
    herb_filepath = f'''{g.SSOT_FOLDERPATH}/herbs/herbs-primary/{herb_slug}.json'''
    ...
    herb_name_all = herb_name_all.replace("'S", "'s")
    ### data loc
    section = f'Sustainability and Conservation'
    brief = f'''
        Include the following subtopics when applicable:
        - Wild harvesting impact
        - Conservation status
...
def herbs__herb__gen(herb):
    ...
    pharmacological_html = herbs__herb_pharmacological__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    mechanisms_html = herbs__herb_mechanisms__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    ...
    dosage_html = herbs__herb_dosage__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    safety_html = herbs__herb_safety__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    drug_html = herbs__herb_drug__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    toxicity_html = herbs__herb_toxicity__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    cultivation_html = herbs__herb_cultivation__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    processing_html = herbs__herb_processing__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    storage_html = herbs__herb_storage__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    scientific_html = herbs__herb_scientific__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
    traditional_html = herbs__herb_traditional__gen(
        herb, json_article_filepath, regen=regen_function, dispel=dispel_function
    )
